...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/09/19 11:58:45 by afeuerst          #+#    #+#             */
/*   Updated: 2017/11/06 13:32:55 by jeblonde         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "purplegreensh.h"

static void	red_rr_close(t_dispatch *const dispatch, const int def,
		const int fd)
{
